...
<div class="row">
  <div class="col-2">
	 <ul class="nav nav-pills" style="display: block;">
		  ...
		  <li class="nav-item">
		    <a class="nav-link  active" href="/zzzz/board/picture_board.jsp">사진게시판</a>
		  </li>
		  <li class="nav-item">
  ...
  <div class="col-10">
    <div class="tab-content" id="v-pills-tabContent">
      ...
      <div class="tab-pane fade  show active" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
      	...
      	<form action="write.po" method="post" name="fr" enctype="multipart/form-data">	
