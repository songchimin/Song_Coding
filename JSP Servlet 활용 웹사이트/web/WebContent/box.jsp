...
<title>Insert title here</title>
	...
	<script type="text/javascript">
		...
		function addBox(lastID, toID, chatContent, chatTime, unread, profile){
			$('#boxTable').append('<tr onclick="location.href=\'/zzzz/index.jsp?toID=' + encodeURIComponent(toID) + '\'">' +
...
<!-- 		세션과 상관없이 지속해서 실행 되어야 하는 부분 -->
	...
	<span id='close' onclick="SirenFunction('SirenDiv'); return false;"><img alt="" src="/zzzz/img/plus.png"></span>
	...
	<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #2980b9; margin: 0 auto;">
		<thead style="background-color:#007BFF;">
			<tr style="height: 32px;">
				<th colspan="3" style="height: 32px; padding: 0;"><h4 style="color: white; margin: 5px"><img onclick="location.href='/zzzz/box.jsp'" alt="" src="./img/arrow_back2.png">회원검색</h4></th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td style="width: 110px;"><h5>회원 아이디</h5></td>
				<td><input class="form-control" type="text" id="findID" maxlength="20" placeholder="찾을 회원 아이디"></td>
