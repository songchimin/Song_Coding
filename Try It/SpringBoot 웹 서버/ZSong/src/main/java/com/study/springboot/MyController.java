...
//		System.out.println("리스트");
	...
	public String stop_contentPage(HttpServletRequest request, HttpServletResponse response, Model model)
			throws ServletException, IOException{
...
//		response.getWriter().write(result.toString());
		...
		session.setAttribute("ban_id",	 id);
		
//		return "/account/stop_content";
		return "/account/member_stop_popup";
