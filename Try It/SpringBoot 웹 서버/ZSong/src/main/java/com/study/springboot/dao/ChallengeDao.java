...
public interface ChallengeDao {
	...
	public void PublicChallenge(String name, String title, String type, String detail, String host);
	...
	public int ChallengeExist(String title, String category, String type, String frequency, String start, String end,
			String fee, String time, String detail, String image, String host);
	public void PrivateUpdate(String title, String category, String type, String frequency, String start, String end,
			String fee, String time, String detail, String image, String host);

	public void CommentRankUpdate(int challenge_num, int comment_num);
}
