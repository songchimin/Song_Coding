...
public class ImageUploadController {
	String filename = "";
	String fileUrl = "";
	String uploadpath = "D:\\finalProject\\file\\Image\\Feed";

	@RequestMapping("/feed_image_upload")
	public void feed_image_upload(@RequestParam("uploadFile") MultipartFile uploadfile) {
