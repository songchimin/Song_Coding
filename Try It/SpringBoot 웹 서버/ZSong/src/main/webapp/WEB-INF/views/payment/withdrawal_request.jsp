    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar" id="side">
      <div class="sidebar-sticky" style="margin-top: 80px;" id="chase">
        <ul class="nav flex-column">
          ...
          <li class="nav-item" style="margin-bottom: 15px;">
            <a class="nav-link" href="#" onclick="withdrawal_request()" style="color: red;">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>
              	환급 신청 내역
            </a>
          </li>
          <li class="nav-item" style="margin-bottom: 15px;">
            <a class="nav-link" href="#" onclick="reward_list()">
...
<table class="table" style="text-align: center;">
  <thead class="table" style="background-color: #333333;">
    <tr style="color: white;">
      ...
      <th scope="col" style="vertical-align:middle; font-size: 10pt;" width="200px;">닉네임</th>
      <th scope="col" colspan="1" style="vertical-align:middle; font-size: 10pt;" width="330px;">계좌정보</th>
      <th scope="col" colspan="1" style="vertical-align:middle; font-size: 10pt;" width="150px;">금액</th>
  ...
  <tbody>
			...
			<tr>
				...
				<td style="vertical-align: middle;">${dto.nickname}</td>

				<td style="color: blue;">${dto.bank} ${dto.account} (예금주:${dto.name})</td>
