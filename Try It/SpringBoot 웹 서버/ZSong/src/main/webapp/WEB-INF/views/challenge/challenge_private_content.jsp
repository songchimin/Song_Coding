...
<script type="text/javascript">
	...
	function approval(num){
		var host = '${challenge.challenge_host}';
			  ...
			  $.ajax({
				    type:'post',
				    url:'/selee/approval_private_content',
...
<!-- 			<tr> -->
<!-- 				<td colspan="4" style="vertical-align: middle; background-color: #3EBDFF;">트라잇 규칙</td> -->
<!-- 			</tr> -->
<!-- 			<tr> -->
					  ...
					  <div class="modal-dialog modal-dialog-centered" role="document">
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					        <button type="button" class="btn btn-primary" onclick="approval('${challenge.challenge_num}')">승인</button>
