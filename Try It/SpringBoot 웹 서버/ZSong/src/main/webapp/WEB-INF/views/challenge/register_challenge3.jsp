...
<!-- #191717; -->
  <thead class="table" style="background-color: #333333;">
    <tr style="color: white;">
      <th scope="col" style="vertical-align:middle; font-size: 12pt;" width="120px;">트라잇 번호</th>
      <th scope="col" style="vertical-align:middle; font-size: 12pt;" width="200px;">카테고리</th>
      <th scope="col" colspan="2" style="vertical-align:middle; font-size: 12pt;" width="330px;">제목</th>
      <th scope="col" style="vertical-align:middle; font-size: 12pt;" width="120px;">구분</th>
...
<!--       <th scope="col" style="vertical-align:middle; font-size: 10pt;">종료일</th> -->
      <th scope="col" colspan="1" style="vertical-align:middle; font-size: 12pt;" width="200px;">신청날짜</th>
