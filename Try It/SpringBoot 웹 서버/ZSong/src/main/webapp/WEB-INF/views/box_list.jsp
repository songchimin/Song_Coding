...
//                   $('#checkModal').modal("show");
      ...
      function getFriend(findID){
         $('#friendResult').html('<thead style="background-color:#2980B9;">' + 
               '<tr>' + 
               ...
               '<tbody>' + 
               '<tr>' + 
               '<td style="text-align: center;"><h3 style="margin-top:10px;">' + findID + '  <a href="/index?toID=' + encodeURIComponent(findID) +'" class="btn btn-outline-primary">' + '메시지 보내기</h3></a></td>' + 
               '</tr>' + 
               '</tbody>');
      }
...
<div class="container" style="padding: 0; margin: 0; width: 100%; height: 100%;">
   <table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #2980b9; margin: 0 auto;">
      ...
      <tbody>
         <tr>
            <td style="width: 110px; vertical-align: middle;"><h5>성명</h5></td>
            <td><input class="form-control" type="text" id="findID" maxlength="20" placeholder="찾을 관리자 아이디"></td>
            <td style="width: 50px;"><button class="btn btn-outline-primary" onclick="findFunction();">검색</button></td>
         </tr>   
      </tbody>
   </table>
</div>
