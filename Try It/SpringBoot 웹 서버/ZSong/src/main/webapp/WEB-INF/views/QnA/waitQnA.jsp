...
<table class="table" style="text-align: center;">
  <thead class="table" style="background-color: #333333;">
    <tr style="color: white;">
      ...
      <th scope="col" style="vertical-align:middle; font-size: 10pt;" width="350px;">제목</th>
...
<!-- 				                				이미지 경로로 수정 -->
			                		...
			                		<tr style="width: 100%;">
			                			<td style="width: 85%;">
			                				<textarea rows="3" cols="50" style="resize: none;" id="con"></textarea>
			                			</td>
			                			<td style="width: 15%;">
...
<!-- 			                		<tr> -->
<!-- 			                			<td style="width: 85%;"> -->
<!-- 			                				<textarea rows="3" cols="100%" style="resize: none;" id="content" name="content"></textarea> -->
<!-- 			                			</td> -->
<!-- 			                			<td style="width: 15%;"> -->
<%-- 			                				<input class="btn btn-primary" style="width: 100%; height: 78px;" type="button" value="등록" onclick="QnAsubmit('${dto.question_num}')"> --%>
<!-- 			                			</td> -->
...
<!-- 			                </li> -->
				...
				<td style="vertical-align: middle;" width="200px;">${dto.question_date}</td>
			</tr>
