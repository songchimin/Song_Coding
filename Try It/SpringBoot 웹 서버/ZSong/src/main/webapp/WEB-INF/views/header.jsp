...
<header><!-- bg-white #FFFED7-->
	<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 border-bottom shadow-sm" style="background-color: #333333;">
      <h5 class="my-0 mr-md-auto font-weight-normal"><a href="/home" style="color:white;">로고or이름</h5>
     ...
     <c:if test="${id==null}">
          ...
          <nav class="my-2 my-md-0 mr-md-3" style="text-align: right;">
        	...
        	<a class="p-2" href="/account_home" style="color: #000000; font-weight: bold;">계정관리</a>
 			<a class="p-2" href="/register_challenge?page=1" style="color: #000000; font-weight: bold;">챌린지 관리</a>
 			...
 			<a class="p-2" href="/waitQnA?page=1" style="color: #000000; font-weight: bold;">Q & A</a>
 			
<!--  			<a class="p-2 text-dark" href="/account_home" style="color: white; font-weight: bold;">계정관리</a> -->
<!--  			<a class="p-2 text-dark" href="/register_challenge?page=1" style="color: white; font-weight: bold;">챌린지 관리</a> -->
<!--  			<a class="p-2 text-dark" href="/cash_mileage?page=1" style="color: white; font-weight: bold;">결제 관리</a> -->
<!--  			<a class="p-2 text-dark" href="/payment_" style="color: white; font-weight: bold;">신고 관리</a> -->
<!--  			<a class="p-2 text-dark" href="/waitQnA?page=1" style="color: white; font-weight: bold;">Q & A</a> -->
 			<c:if test="${id!=null}">
