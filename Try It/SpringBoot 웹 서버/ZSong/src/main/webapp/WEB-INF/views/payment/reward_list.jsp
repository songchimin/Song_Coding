...
<script type="text/javascript">
	...
	function reward_list(){
		javascript:window.location='reward_list?page=1';
	}
      ...
      <div class="sidebar-sticky" style="margin-top: 80px;" id="chase">
        <ul class="nav flex-column">
          <li class="nav-item" style="margin-bottom: 15px;">
            <a class="nav-link active" href="#" onclick="cash_mileage()">
          ...
          <li class="nav-item" style="margin-bottom: 15px;">
            <a class="nav-link" href="#" onclick="reward_list()" style="color: red;">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <nav class="my-2 my-md-0 mr-md-3" style="text-align: right;">
        	...
        	<a class="p-2" href="/account_home" style="color: #000000;  font-weight: bold;">계정관리</a>
 			...
 			<a class="p-2" href="/cash_mileage?page=1" style="color: red; font-weight: bold;">결제 관리</a>
...
<table class="table" style="text-align: center;">
  <thead class="table" style="background-color: #333333;">
    <tr style="color: white;">
      <th scope="col" style="vertical-align:middle; font-size: 10pt;" width="120px;">회원번호</th>
      <th scope="col" style="vertical-align:middle; font-size: 10pt;" width="200px;">챌린지번호</th>
      <th scope="col" colspan="1" style="vertical-align:middle; font-size: 10pt;" width="330px;">상금액</th>
      <th scope="col" colspan="1" style="vertical-align:middle; font-size: 10pt;" width="200px;">날짜</th>
      <th scope="col" style="vertical-align:middle; font-size: 10pt;" width="120px;">지급완료</th>
    </tr>
    
  </thead>

  <tbody>
    		<c:forEach items="${record_list}" var="dto">
			
			<tr>
				<th scope="row" style="vertical-align: middle;">${dto.member_num}			    
				<td style="vertical-align: middle;">${dto.challenge_num}</td>
				<td style="color: blue; vertical-align: middle;" colspan="1">${dto.reward}</td>
				<td style="vertical-align: middle;" width="250px;">${dto.receipt}</td>
