...
<script type="text/javascript">
	...
	function Comment_submit(num, num2, check){
		var content = document.getElementById('content').value;
		var id = '<%=id%>';
		
		  $.ajax({
			    type:'post',
			    url:'/vote_comment_submit',
			    data: ({num:num, num2:num2, content:content, id:id, check:check}),
			    ...
			    success:function(data){
				    ...
				    {
					    document.location.href="vote_comment_report?page=${cpage}";
				    }
			    }
    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar" id="side">
      <div class="sidebar-sticky" style="margin-top: 80px;" id="chase">
        <ul class="nav flex-column">
          ...
          <li class="nav-item" style="margin-bottom: 15px;">
            <a class="nav-link" href="#" onclick="wait_vote_Report()" style="color: red;">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>
              	댓글 신고 내역
            </a>
          </li>
...
<table class="table" style="text-align: center;">
  <thead class="table" style="background-color: #333333;">
    <tr style="color: white;">
      ...
      <th scope="col" style="vertical-align:middle; font-size: 10pt;" width="450px;">신고내용</th>
...
<!--       <th scope="col" style="vertical-align:middle; font-size: 10pt;" width="100px;">답변일</th> -->
  ...
  <tbody>
    		<c:forEach items="${comment_report}" var="dto">
			
			<tr>
				<th scope="row" style="vertical-align: middle;">${dto.complaint_num}			    
				<td style="vertical-align: middle;">${dto.member_id}</td>
				<td style="vertical-align: middle;">

					<li class="menu"  style="list-style: none; align-content: center;">
						<c:if test="${dto.complaint_state==1}">
							<a href="#">${dto.complaint_content} <span class="badge badge-warning">처리완료</span></a> 
							...
							<ul class="hide" style="list-style: none; text-align: left; padding:0; margin: 0;">
				                <li style="margin-bottom: 0;">
				                	<table style="vertical-align: middle; width: 100%;">
					                	...
					                	<tr style="width: 100%;">
					                		<td colspan="1" width="80%" style="text-align: left;">
	<%-- 											${dto.comment_content} --%> - 삭제완료 -
					                		</td>
					                	</tr>
					            		<tr style="width: 100%;">
						...
						<c:if test="${dto.complaint_state==0}">
							<a href="#">${dto.complaint_content}</a>
							<ul class="hide" style="list-style: none; text-align: left; padding:0; margin: 0;">
				                <li style="margin-bottom: 0;">
				                	<table style="vertical-align: middle; width: 100%;">
					                	<tr style="width: 100%;">
					            		...
					            		<tr style="width: 100%;">
					                		<td width="70%" style="text-align: left;">
												<textarea rows="3" style="width: 100%" id="content"></textarea>
					                		</td>
					                		<td width="10%" style="vertical-align: middle;">
					                			<button class="btn" style="height: 38px; margin-bottom: 3px;" onclick="Comment_submit(${dto.complaint_num},${dto.comment_num},0)">삭제</button>
					                			<button class="btn" style="height: 38px;" onclick="Comment_submit(${dto.complaint_num},${dto.comment_num},0)">답변</button>
					                		</td>
					                	</tr>	                	
				                	</table>
				                </li>
				...
				<td style="vertical-align: middle;">${dto.complaint_date}</td>
