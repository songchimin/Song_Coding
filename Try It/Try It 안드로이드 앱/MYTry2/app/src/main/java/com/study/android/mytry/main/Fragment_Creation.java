    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        public_btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                fragmentTransaction.add(R.id.fragment_creation, new com.study.android.mytry.challenge_public.CreationMain()).addToBackStack(null).commit();
            }
        });
        ...
        private_btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                fragmentTransaction.add(R.id.fragment_creation, new com.study.android.mytry.challenge_private.CreationMain()).addToBackStack(null).commit();
            }
        });
        return rootView;
    }
