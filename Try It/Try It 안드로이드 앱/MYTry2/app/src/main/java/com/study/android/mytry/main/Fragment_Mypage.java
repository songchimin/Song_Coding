...
public class Fragment_Mypage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.add(R.id.mypage, new SetupMain()).addToBackStack(null).commit();
            }
        });
        ...
        challengeList = rootView.findViewById(R.id.mypage_challenge_list);
    ...
    public class MyChallengeTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String json) {
            ...
            try {
                MyChallengeAdapter myChallengeAdapter = new MyChallengeAdapter(getActivity());
                ...
                if (json != null) {
                    ...
                    setListViewHeightBasedOnChildren(challengeList);
                    if (getActivity().isFinishing()) {
                        return;
                    }
                }
