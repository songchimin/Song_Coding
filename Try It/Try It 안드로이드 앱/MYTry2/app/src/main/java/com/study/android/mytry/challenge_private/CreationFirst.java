...
public class CreationFirst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nickname = findViewById(R.id.textViewh4);
        ...
        if (intent.getSerializableExtra("hashmap") != null) {
            ...
            if (map.get("category").equals("역량")) {
                check_capability.setChecked(true);
            } else if (map.get("category").equals("건강")) {
                check_health.setChecked(true);
            } else if (map.get("category").equals("관계")) {
                check_relationship.setChecked(true);
            } else if (map.get("category").equals("자산")) {
                check_life.setChecked(true);
            } else if (map.get("category").equals("생활")) {
                check_assets.setChecked(true);
            } else if (map.get("category").equals("취미")) {
                check_hobby.setChecked(true);
            }

            if (map.get("type").equals("카메라")) {
                check_camera.setChecked(true);
            } else if (map.get("type").equals("갤러리")) {
                check_gallery.setChecked(true);
            } else if (map.get("type").equals("녹음")) {
                check_voice.setChecked(true);
            } else if (map.get("type").equals("지도")) {
                check_map.setChecked(true);
            } else if (map.get("type").equals("영화")) {
                check_movie.setChecked(true);
            }
    ...
    public void onFirstNext(View v) {
        ...
        Log.d("lecture", title.getText().toString());
