...
public class CreationFifth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nickname = findViewById(R.id.textViewh1);
        ...
        if (map.get("first_image") != null) {

            String imageurl = local_url + "/";
            imageurl = imageurl + map.get("first_image") + ".jpg";
    ...
    public void onFifthNext(View v) {
            ...
            if (Integer.parseInt(cash) < Integer.parseInt(map.get("fee")) * 10000) {
                ...
                Intent intent = new Intent(CreationFifth.this, Kakao_cash.class);
                ...
                Toast.makeText(CreationFifth.this, "우리끼리 트라잇 신청이 완료되었습니다.", Toast.LENGTH_LONG).show();
